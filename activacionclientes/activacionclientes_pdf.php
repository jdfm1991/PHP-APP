...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Ln(20);
        // titulo de columnas
        $this->Cell(17, 6, 'Ult Venta', 1, 0, 'C', 0);
        $this->Cell(24, 6, 'Cod Cliente', 1, 0, 'C', 0);
        $this->Cell(80, 6, utf8_decode('Descripción'), 1, 0, 'C', 0);
        $this->Cell(22, 6, 'Rif', 1, 0, 'C', 0);
        $this->Cell(21, 6, 'CodVend', 1, 0, 'C', 0);
        $this->Cell(27, 6, 'Pendiente', 1, 1, 'C', 0);
