			...
			<!-- BOX FORMULARIO -->
				...
				<div class="card card-info" id="tabla_detalle">
					<div class="card-header">
						<h3 class="card-title">Relación de Notas de Entregas por Pagar</h3>
					</div>
						...
						<table class="table table-hover table-condensed table-bordered table-striped text-center" style="width:100%;" id="cobrar_data_detalle">
							<thead style="background-color: #17A2B8;color: white;">
								<tr>
									...
									<th class="text-center" title="Código Proveedor">Código Proveedor</th>
                                    <th class="text-center" title="Proveedor">Proveedor</th>
									<th class="text-center" title="Telefono">Telefono</th>
