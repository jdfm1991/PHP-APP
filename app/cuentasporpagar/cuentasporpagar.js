    ...
    var fechaf = $("#fechaf").val();
        ...
        estado_minimizado = false;
            ...
            tabla = $('#cobrar_data').DataTable({
                ...
                "ajax": {
                    url: "cuentasporpagar_controlador.php?op=buscar_NEporcobrar",
                    type: "post",
                    dataType: "json",
...
$(document).on("click","#btn_excel", function(){
   ...
   var fechaf = sessionStorage.getItem("fechaf", fechaf);
    ...
    window.location = "cuentasporpagar_excel.php?&fechai="+fechai+"&fechaf="+fechaf;
...
$(document).on("click","#btn_pdf", function(){
    ...
    var fechaf = sessionStorage.getItem("fechaf", fechaf);
    if (fechai !== "" && fechaf !== "") {
        window.open('cuentasporpagar_pdf.php?&fechai='+fechai+'&fechaf='+fechaf,'_blank');
    }
});
