...
switch ($_GET["op"]) {
    ...
    case "buscar_ingresoxdia":
        ...
        foreach ($datos as $row){
            ...
            $bolivares2=$row['Vendidobs']-($row['Devolucionesbs']+$row['Descuentobs']);
            $dolar2=$row['Vendido']-($row['Devoluciones']+$row['Descuento']);
        }
        ...
        $output = array(
            "ingreso_in_bs" => Strings::rdecimal(($Totalbs),2),
            "ingreso_in_dolar"  => Strings::rdecimal(($Totaldolar),2),
        );
