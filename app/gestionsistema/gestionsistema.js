...
function cargar_datosGrafica() {
    $.ajax({
        async: false,
        cache: true,
        url: 'gestionsistema_controlador.php?op=datos_grafico_menus',
        method: "post",
        dataType: "json",
...
function listar_modulos() {
    ...
    tabla_modulo = $('#modulo_data').dataTable({
        ...
        "ajax":
            {
                url: 'gestionsistema_controlador.php?op=listar_modulos',
                type: "get",
                dataType: "json",
                beforeSend: function () {
...
function listar_menus() {
    ...
    tabla_menu = $('#menu_data').dataTable({
        ...
        "ajax":
            {
                url: 'gestionsistema_controlador.php?op=listar_menu',
                type: "get",
                dataType: "json",
                beforeSend: function () {
                    SweetAlertLoadingShow();
...
function cambiarEstado_modulo(id, est) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: "gestionsistema_controlador.php?op=activarydesactivar_modulo",
                method: "POST",
                data: {id: id, est: est},
                success: function (data) {
...
function cambiarEstado_menu(id, est) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: "gestionsistema_controlador.php?op=activarydesactivar_menu",
                method: "POST",
                data: {id: id, est: est},
                success: function (data) {
...
function mostrar_menu(id_menu= -1) {
    ...
    $.ajax({
        url: "gestionsistema_controlador.php?op=mostrar_menu",
        method: "POST",
        dataType: "json",
...
function guardaryeditarModulo(e) {
    ...
    if (ruta !== "") {
        $.ajax({
            url: "gestionsistema_controlador.php?op=guardaryeditar_modulo",
            type: "POST",
            data: formData,
            dataType: "json",
            contentType: false,
...
function guardaryeditarMenu(e) {
    ...
    $.ajax({
        url: "gestionsistema_controlador.php?op=guardaryeditar_menu",
        type: "POST",
        data: formData,
        dataType: "json",
        contentType: false,
...
function guardarMenuSeleccionado(id, key, tipo) {
    ...
    $.ajax({
        url: "gestionsistema_controlador.php?op=guardarseleccionado",
        type: "POST",
        dataType: "json",
...
function eliminar_menu(id, menu) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: "gestionsistema_controlador.php?op=eliminar_menu",
                method: "POST",
                dataType: "json",
                data: {id: id},
                error: function (e) {
