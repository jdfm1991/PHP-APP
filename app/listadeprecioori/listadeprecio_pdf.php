...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        */
        ...
        switch ($GLOBALS['sumap']) {
            case 1:
                $this->Cell(addWidthInArray(25), 6, 'Pre '.$GLOBALS['sumap2'].' Paq', 1, 0, 'C', true);
                break;
            case 2:
            ...
            default: /** 0 || 3**/
                ...
                $this->Cell(addWidthInArray(25), 6, utf8_decode(Strings::titleFromJson('precio3_paquete')), 1, 0, 'C', true);
        }
        //unidad
        $this->Cell(addWidthInArray(18  + ($anchoAdicional*0.10)), 6, utf8_decode(Strings::titleFromJson('unidad')), 1, 0, 'C', true);
        switch ($GLOBALS['sumap']) {
            case 1:
                $this->Cell(addWidthInArray(25), 6, 'Pre '.$GLOBALS['sumap2'].' Uni', 1, $aux, 'C', true);
                break;
            case 2:
                if($GLOBALS['p1'] == 1){ $pAux = $GLOBALS['p1']; }else{ $pAux = $GLOBALS['p2'];}
                $this->Cell(addWidthInArray(25), 6, 'Pre '.$pAux.' Uni', 1, 0, 'C', true);
                if ($GLOBALS['p3'] == 3){ $pAux = $GLOBALS['p3']; }else{ $pAux = $GLOBALS['p2'];}
                $this->Cell(addWidthInArray(25), 6, 'Pre '.$pAux.' Uni', 1, $aux, 'C', true);
                break;
            default: /** 0 || 3**/
                $this->Cell(addWidthInArray(25), 6, utf8_decode(Strings::titleFromJson('precio1_unidad')), 1, 0, 'C', true);
                $this->Cell(addWidthInArray(25), 6, utf8_decode(Strings::titleFromJson('precio2_unidad')), 1, 0, 'C', true);
                $this->Cell(addWidthInArray(25), 6, utf8_decode(Strings::titleFromJson('precio3_unidad')), 1, $aux, 'C', true);
        }
        if ($GLOBALS['cubi'] == 1) {
