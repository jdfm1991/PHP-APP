...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Recepción de Compra
                            (<?php
                            switch ($_GET['t']) {
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item">Recepción de Compra</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
        ...
        <div class="content">
            ...
            <table id="tabla" class="table table-sm text-center table-condensed table-bordered table-striped table-responsive table-primary" style="width:100%;">
                ...
                <tr id="cells">
                    ...
                    <th class="small align-middle" style="width:10%">Código Proveedor</th>
                    <th class="small align-middle" style="width:20%">Descripción Proveedor</th>
                    <th class="small align-middle" style="width:7%">Documento</th>
                    <th class="small align-middle" style="width:10%">Código Producto</th>
                    <th class="small align-middle" style="width:20%">Descripción Producto</th>
                    <th class="small align-middle" style="width:7%">Costo Unitario</th>
                    <th class="small align-middle" style="width:7%">Cantidad</th>
                    <th class="small align-middle" style="width:7%">Costo Total</th>
                    <th class="small align-middle" style="width:10%">Fecha</th>
                    <th class="small align-middle" style="width:10%">Tasa</th>
                </tr>
                </thead>
            ...
            <!-- /.container-fluid -->
            <div class="container">
                <a href="recepcion_compras_excel.php?&fechai=<?php echo $_GET['fechai']; ?>&fechaf=<?php echo $_GET['fechaf']; ?>&t=<?php echo $_GET['t']; ?>" class="card-link" id="btn_excel">
    ...
    <script type="text/javascript" src="recepcion_compras_tabla.js"></script>
</div>
<!-- ./wrapper -->
