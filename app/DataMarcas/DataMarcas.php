...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    if (!PermisosHelpers::verficarAcceso( Functions::getNameDirectory() )) {
                        ...
                        <div class="card-body">
                            ...
                            <div class="card card-info"  id="tabla">
                                <div class="card-header">
                                    <h3 class="card-title">Objetivo en Volumen</h3><!-- overflow:scroll; -->
                                </div>

                                <div class="card-body" style="width:auto;">
                                    <table class="table table-hover table-condensed table-bordered table-striped text-center" style="width:100%;" id="Data_Entry_Marcas">
                                        <thead style="background-color: #17A2B8;color: white;">
                                        <tr>
                                            <th  class="text-center" title="Marcas">Marcas</th>
        ...
        <script type="text/javascript" src="DataMarcas.js"></script><?php
    }
    ?>
</body>
</html>
