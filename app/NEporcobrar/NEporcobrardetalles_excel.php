...
$sheet->setCellValue('A7', (Strings::titleFromJson('tipo_transaccion')))
    ...
    ->setCellValue('I7', Strings::titleFromJson('ruta'))
    ->setCellValue('J7', Strings::titleFromJson('supervisor'));
...
foreach ($query as $i) {
    ...
    $sheet->setCellValue('I' . $row, $i['Ruta']);
    $sheet->setCellValue('J' . $row, $i['Supervisor']);
