...
$spreadsheet->getActiveSheet()->getStyle('A1:G1')->getFont()->setSize(25);
 ...
 $sheet->setCellValue('A1', 'Notas de Entregas Pendientes por Cobrar');
...
$query = $notasE->getNEporcobrar( $fechai, $fechaf);
...
header('Content-Disposition: attachment;filename="Notas de Entregas Pendientes por Cobrar del '.$fechai.' hasta '.$fechaf.'.xlsx"');
