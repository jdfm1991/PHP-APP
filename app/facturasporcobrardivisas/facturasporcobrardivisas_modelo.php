	...
	public function getfacturasporcobrardivisas($fechai, $fechaf){
       ...
       parent::set_names();
        ...
        if ($fechai == "" and $fechaf == ""){
          ...
          (case when saacxc.tipocxc = 10 then (select CONVERT( VARCHAR ,fechad,103) from appfacturas inner join [AJ].[dbo].appfacturas_det on appfacturas.correl = appfacturas_det.correl where 
