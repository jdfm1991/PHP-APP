...
$sheet->setCellValue(getExcelCol($i).$row, Strings::titleFromJson('paquete'));
$sheet->setCellValue(getExcelCol($i).$row, Strings::titleFromJson('unidades'));
            ...
            $sub_array['montod']        =  number_format($montod  * $multiplicador, 2);
                ...
                if($row["unid"]=='BULT'){
                    if($factor == 0 ){
                       ...
                       if( ((((($montod  * $multiplicador)-($descuento  * $multiplicador))) )*100) == 0 ){
                        $sub_array['rentabilidad']  =   Strings::rdecimal( 0,2);
                       }else{
