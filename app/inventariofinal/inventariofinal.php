...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    if (!PermisosHelpers::verficarAcceso( Functions::getNameDirectory() )) {
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Inventario Final</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <section class="content">
                ...
                <div class="card card-info">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-success" id="btn_inventariofinal"><i class="fa fa-search" aria-hidden="true"></i><?=Strings::titleFromJson('boton_consultar')?></button>
                    </div>
                </div>
                <!-- BOX TABLA -->
                <div class="card card-info" id="tabla">
                    ...
                    <div class="card-body">
                        <div class="row table-responsive"  style="height: 300px;">
                            <table class="table table-hover table-condensed table-bordered table-striped table-sm table-head-fixed text-nowrap text-center" style="width:100%;" id="inventariofinal_data">
                                <thead >
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" id="tfoot_cant_monto">Monto Total</th>
                                </tr>
                                </tfoot>
                                <tbody>
        ...
        <script type="text/javascript" src="inventariofinal.js"></script><?php
    }
    ?>
</body>
</html>