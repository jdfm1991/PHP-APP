...
<div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-body">
                    ...
                    <button class="btn btn-primary" id="btn_add_despacho" onclick="limpiar()" data-toggle="modal" data-target="#modal_add_despacho">Nuevo Despacho  <i class="fa fa-plus-circle" aria-hidden="true"></i></button>
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Relacion de Despachos</h3><!-- overflow:scroll; -->
                        </div>
    ...
    <!-- Modal crear -->
    <div class="modal fade"  id="modal_add_despacho" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Crear Despacho</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="post" id="add_despacho_form">
                        ...
                        <div class="modal-footer">
                            <button type="submit" name="action" id="btnGuardar" class="btn btn-success pull-left" value="Add">Crear nuevo</button>
