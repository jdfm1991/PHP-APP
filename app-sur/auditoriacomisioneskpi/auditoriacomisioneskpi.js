...
function listar_vendedores() {
    let isError = false;
    $.ajax({
        url: "auditoriacomisioneskpi_controlador.php?op=listar_vendedores",
        method: "POST",
        dataType: "json",
        beforeSend: function () {
    ...
    if (estado_minimizado) {
        ...
        if (fechai !== "" && fechaf !== "") {
            ...
            tabla = $('#tabla_data').DataTable({
                ...
                "ajax": {
                    url: "auditoriacomisioneskpi_controlador.php?op=buscar_auditoriacomisioneskpi",
                    type: "post",
                    dataType: "json",
...
$(document).on("click","#btn_excel", function(){
   ...
   if (fechai !== "" && fechaf !== "" ) {
    window.location = "auditoriadecomisioneskpi_excel.php?&fechai="+fechai+"&fechaf="+fechaf+"&vendedor="+vendedor;
}
});
/*
