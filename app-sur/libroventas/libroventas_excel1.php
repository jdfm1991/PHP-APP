...
if (is_array($datos)==true and count($datos)>0)
{
    foreach ($datos as $key => $row)
    {
        ...
        if($totalventasconiva>=1000){
            ...
            $sub_array['totalventasconiva'] = number_format($totalventasconiva, 2);
        }
        ...
        if($row["mtoexento"]>=1000){
            ...
            $sub_array['mtoexento'] = number_format($row["mtoexento"], 2);
        }
        ...
        if($base_imponible>=1000){
            ...
            $sub_array['base_imponible'] = number_format($base_imponible, 2);
        }
        ...
        if($row["alicuota_contribuyeiva"]>=1000){
            ...
            $sub_array['alicuota_contribuyeiva'] = number_format($row["alicuota_contribuyeiva"], 0);
        }
        ...
        if($row["montoiva_contribuyeiva"]>=1000){
            ...
            $sub_array['montoiva_contribuyeiva'] = number_format($row["montoiva_contribuyeiva"], 2);
        }
