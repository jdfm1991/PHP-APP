...
$sheet->setCellValue('A7', (Strings::titleFromJson('tipo_transaccion')))
    ...
    ->setCellValue('H7', Strings::titleFromJson('dias_transcurridos'))
    ->setCellValue('I7', Strings::titleFromJson('dias_transcurridos_hoy'))
    ->setCellValue('J7', Strings::titleFromJson('saldo_pendiente'))
    ->setCellValue('K7', Strings::titleFromJson('saldo_pendiente_$'))
...
foreach ($query as $i) {
    ...
    if($i["SaldoPendolar"]>=1000){

        $SaldoPendolar = ($i["SaldoPendolar"]);

    }else{
        $SaldoPendolar = number_format($i["SaldoPendolar"], 2);
    }
    ...
    $sheet->setCellValue('G' . $row, $fecha_D);
    $sheet->setCellValue('H' . $row, $i['DiasTrans']);
    $sheet->setCellValue('I' . $row, $i['DiasTransHoy']);
    $sheet->setCellValue('J' . $row, $total);
    $sheet->setCellValue('K' . $row, $SaldoPendolar);
