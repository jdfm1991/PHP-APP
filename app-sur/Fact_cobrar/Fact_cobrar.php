        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h2>Facturas Pendientes por Cobrar por Ruta</h2>
                        </div>
                        <div class="col-sm-6">
            ...
            <section class="content">
                ...
                <div class="card card-info" id="tabla">
                    ...
                    <div class="card-body table-responsive mt-2 p-0" style="width:100%; height:400px;">
                        <table class="table table-sm table-hover table-condensed table-bordered table-striped table-head-fixed text-nowrap text-center" id="Fact_cobrar_data">
