       ...
       parent::set_names();
        ...
        if($tipo == 'B'){
           ...
           $sql = "SELECT  [TipoCxc]
                  ...
                  ,[Monto]
                  ,[SaldoAct]
              FROM [DCONFISUR_PZO_D].[dbo].[SAACXC] inner join SACLIE on SACLIE.CodClie=SAACXC.CodClie where  TipoCxc='31' AND DATEADD(dd, 0, DATEDIFF(dd, 0, [SAACXC].fechae)) between '$fechai' and '$fechaf'";
