    ...
    var fechaf = $("#fechaf").val();
        ...
        estado_minimizado = false;
            ...
            tabla = $('#cobrar_data').DataTable({
                ...
                "ajax": {
                    url: "facturasporcobrardivisas_controlador.php?op=buscar_facturasporcobrar",
                    type: "post",
                    dataType: "json",
...
$(document).on("click","#btn_excel", function(){
   ...
   var fechaf = sessionStorage.getItem("fechaf", fechaf);
    ...
    window.location = "facturasporcobrardivisas_excel.php?&fechai="+fechai+"&fechaf="+fechaf;
...
$(document).on("click","#btn_pdf", function(){
    ...
    var fechaf = sessionStorage.getItem("fechaf", fechaf);
    if (fechai !== "" && fechaf !== "") {
        window.open('facturasporcobrardivisas_pdf.php?&fechai='+fechai+'&fechaf='+fechaf,'_blank');
    }
});
